class DistanceEstimationSettingsController < ApplicationController
  ...
  def update
    @setting.update_attributes(rate_group_id: params[:rate_group_id],up_to_mile: params[:up_to_mile],base_charge: params[:base_charge],cost_per_distance: params[:cost_per_distance],miles_per_distance: params[:miles_per_distance])
